...
public class CvUtilsFX {
    //метод преобразования Mat в WriteableImage с использованием буфера
    ...
    //метод преобразования Mat в WriteableImage без буфера (работает быстрее за счет отсутствия промежуточного объекта)
